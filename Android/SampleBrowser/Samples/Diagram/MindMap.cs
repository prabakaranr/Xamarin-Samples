...
namespace SampleBrowser
{
    public partial class MindMap : SamplePage
    {
        ...
        internal void UpdateTheme()
        {
            ...
            (diagram.LayoutManager.Layout as MindMapLayout).UpdateLayoutStyle(new LayoutStyle(nodeStyleCollection, lineStyle, ApplyNodeStyleBy.Branch, true));
        }
        ...
        private void AddHandles()
        {
            ...
            RightSideHandle.Add(new UserHandle("Right", UserHandlePosition.Right, GetHandleImage("mindmapplus.png")));
            RightSideHandle.Add(new UserHandle("Delete", UserHandlePosition.Bottom, GetHandleImage("mindmapdelete.png")));
            RightSideHandle.Add(new UserHandle("ExpColl", UserHandlePosition.BottomLeft, GetHandleImage("mindmapcollpase.png")));
            RightSideHandle.Add(new UserHandle("info", UserHandlePosition.TopRight, GetHandleImage("mindmapmore.png")));

            LeftSideHandles = new UserHandleCollection(diagram);
            LeftSideHandles.Add(new UserHandle("Left", UserHandlePosition.Left, GetHandleImage("mindmapplus.png")));
            LeftSideHandles.Add(new UserHandle("Delete", UserHandlePosition.Bottom, GetHandleImage("mindmapdelete.png")));
            LeftSideHandles.Add(new UserHandle("ExpColl", UserHandlePosition.BottomLeft, GetHandleImage("mindmapcollpase.png")));
            LeftSideHandles.Add(new UserHandle("info", UserHandlePosition.TopRight, GetHandleImage("mindmapmore.png")));
        }
